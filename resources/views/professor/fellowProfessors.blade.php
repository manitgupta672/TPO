			...
			<div class="widget col s12 m12 l12 textwhite ">
			 <div class="card light-green darken-1 hoverable">
				<div class="card-content white-text">
					...
					<hr>
							@if(!empty($fellowProfessors))
						<table id="fellowProfessors">
							<thead>
								<tr>
									<th>Name</th>
									<th>Branch</th>
							...
							<tbody>
								...
								@foreach($fellowProfessors as $fellowProfessor)
									<tr>
										<td>{{$fellowProfessor->name}}</td>
										<td>{{$fellowProfessor->branch}}</td>
										<td>{{$fellowProfessor->mobile}}</td>
									</tr>
								@endforeach
							</tbody>
						</table>
