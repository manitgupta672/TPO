         ...
         <nav class="blue-grey darken-3 z-depth-3" style="border-radius:0 0 5px 5px;" >
          <div class="nav">
            ...
            <ul id="dropdown3" class="dropdown-content col s12 m12 l12 ">
              ...
              <li class=""><a href="/company/panel">Dashboard</a></li>
              <li class=""><a href="/company/panel/jaf">Job Application Form</a></li>
							<li class=""><a href="/company/panel/myStudents">Students For Your Company</a></li>
              <li class=""><a href="/company/panel/news">News</a></li>
