<html>
    ...
    <title>MBM : PROFESSOR PANEL</title>
         ...
         <nav class="blue-grey darken-3 z-depth-3" style="border-radius:0 0 5px 5px;" >
          <div class="nav">
            ...
            <ul id="dropdown3" class="dropdown-content col s12 m12 l12 ">
              ...
              <li><a href="/professor/panel">Dashboard</a></li>
							<li><a href="/professor/panel/students">Students</a></li>
              <li><a href="/professor/panel/fellowprofessor">Fellow Professor</a></li>
              <li><a href="/professor/panel/news">News</a></li>
